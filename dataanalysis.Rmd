...
library(readr)
library(dplyr)
df <- read_csv("/alphadata01/bstocker/data/gcme/data_received_190325/NewData_wide_CORRECTED2.csv") %>%
...
df_long <- df %>% 
  ...
  wide_to_long_gcme(keyvars) %>% 
  write_csv(path="/alphadata01/bstocker/data/gcme/data_received_190325/NewData_LONG.csv")
```
...
df_wide_c <- df_long %>% 
  ...
  long_to_wide_gcme("c") %>% 
  write_csv(path="/alphadata01/bstocker/data/gcme/data_received_190325/NewData_WIDE_c.csv")
```
...
```{r, warning=FALSE}
df_anpp <- read_csv("/alphadata01/bstocker/data/gcme/data_received_190325/table_var_exp_names_anpp.csv") %>% 
  ...
  left_join( 
    read_csv("/alphadata01/bstocker/data/gcme/data_received_190325/table_var_exp_names_experiments.csv") %>% 
